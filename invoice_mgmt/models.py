...
class Invoice(models.Model):
    """a class that defines what the invoice model should look like"""
    ...
    name = models.CharField('Client Name', max_length=160, default='', blank=True, null=True)

    line_one = models.CharField('Line 1', max_length=160, default='', blank=True, null=True)
    ...
    line_two = models.CharField('Line 2', max_length=160, default='', blank=True, null=True)
    ...
    line_three = models.CharField('Line 3', max_length=160, default='', blank=True, null=True)
    ...
    line_four = models.CharField('Line 4', max_length=160, default='', blank=True, null=True)
    ...
    line_five = models.CharField('Line 5', max_length=160, default='', blank=True, null=True)
    ...
    line_six = models.CharField('Line 6', max_length=160, default='', blank=True, null=True)
    ...
    line_seven = models.CharField('Line 7', max_length=160, default='', blank=True, null=True)
    ...
    line_eight = models.CharField('Line 8', max_length=160, default='', blank=True, null=True)
    ...
    line_nine = models.CharField('Line 9', max_length=160, default='', blank=True, null=True)
    ...
    phone_number = models.CharField(max_length=160, default='', blank=True, null=True)
    total = models.IntegerField(default=0, blank=True, null=True)
    balance = models.IntegerField(default=0, blank=True, null=True)
    timestamp = models.DateTimeField(auto_now_add=True, auto_now=False)
    last_updated = models.DateField(auto_now_add=False, auto_now=True, blank=True)
    paid = models.BooleanField(default=False) #tick if its paid or not
    invoice_type_choice = (
            ('', 'Select Invoice Type'), 
            ('Receipt', 'Receipt'),
            ('Proforma Invoice', 'Proforma Invoice'),
            ('Invoice', 'Invoice')
     ) #a drop down that will select the type of invoice you want
    invoice_type = models.CharField(max_length=50, default='', blank=True, null=True, choices=invoice_type_choice)

    def __str__(self):
        return f"Invoice #{self.invoice_number}" if self.invoice_number else "invoice (No Number)"