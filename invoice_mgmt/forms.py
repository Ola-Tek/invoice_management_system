...
class InvoiceForm(forms.ModelForm):
    """A class that describes a user invoice form."""
    class Meta:
        model = Invoice
        fields = [
    ...
    def clean_invoice_number(self):
        """a function that validates the data being asked for or the data to add"""
    ...
    def clean_name(self):
        """function that validates the name being requested, such that the data must be valid"""
    ...
    def clean_line_one(self):
        """clean the data requested for line one"""
    ...
    def clean_line_one_quantity(self):
        """it validates the field for line one quantity by making sure there is a valid data being passed and not leaving it as empty string"""
